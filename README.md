...
(EDA notebook available in notebooks/01_eda.ipynb)
...
All transformations are stored inside a single reusable feature pipeline.

🤖 Model Training & Evaluation

Multiple models were trained and compared using consistent metrics.
...
Shows feature contributions positively and negatively

Integrated directly inside the Streamlit app

This enables business-friendly interpretability.

🚀 Streamlit Application

The project includes a production-ready Streamlit app with:
...
SHAP explanation for that prediction

📁 Batch Prediction

CSV upload

Predict thousands of passengers
